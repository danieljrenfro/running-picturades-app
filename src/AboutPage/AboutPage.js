  ...
  render() {
    return (
      <section className="app-instructions">
        ...
        <p>Running Picturades is a game with 2-4 teams. In every game you have a Word Giver who creates a list of words, decides whether it will be pictionary or charades and administers those words to the teams. At the beginning, each team will send one player to the Word Giver. The Word Giver will tell each player the initial word. The players run back to their teams and begin either acting or drawing depending on the game type.</p>
        ...
        <p>If you want to create your own lists, you will need to login to an account. You can either register for a new account or you can sign into 'testUser' with password: 'Password1!'.</p>
